...
// https://twitter.com/akmalfirdxus/status/1646610766840119296?s=20
// tweetId : 1646610766840119296
// https://platform.twitter.com/embed/Tweet.html?id=1646610766840119296&darkMode=true&showThread=false&locale=en
const getEmbeddableTweetUrl = (tweetId: string, options: Options) => {
	...
	// In each iteration of the loop, the set() method is called on the searchParams object with the key and value of the current property in searchParameters as arguments. 
	// This adds or updates the search parameter with the given key and value to the query string of the URL.

	// So, for example, if searchParameters contains { id: '12345', theme: 'dark' }, 
	// then the loop will set the search parameters id=12345 and theme=dark on the embeddableTweetUrl URL object.
